...
const RegisterUsersScreen: React.FC = () => {
  const [users, setUsers] = useState<User[]>([
    { id: '1', name: 'User', email: 'user1@user.com', birthdate: '1990-01-01', gender: 'Male', phone: '123-456-7890' },
  ...
  const updateUser = () => {
    setUsers(users.map((user) => 
      (user.id === editUser ? { ...user, name, email, birthdate, gender, phone } : user)
    ));
    resetForm();
  };
            ...
            return (
                ...
                <View style={styles.userContainer}>
                  <View>
                    ...
                    <Text style={styles.userDetails}>Birthdate: {user.birthdate}</Text>
                    <Text style={styles.userDetails}>Gender: {user.gender}</Text>
