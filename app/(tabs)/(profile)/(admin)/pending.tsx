...
const Pending = () => {
  ...
  const handleDeny = (companyId: number) => {
    ...
    <ScrollView style={styles.container}>
      {pendingCompanies.map((company) => (
        <View key={company.id} style={styles.card}>
          ...
          <Text style={styles.detail}>Physical Address: {company.physicalAddress}</Text>
          <Text style={styles.detail}>Wallet Address: {company.walletAddress}</Text>
          <Text style={styles.detail}>Required Papers: {company.papers}</Text>

          <View style={styles.buttonContainer}>
            <TouchableOpacity
              style={styles.approveButton}
              onPress={() => handleApprove(company.id)}
            >
              <Text style={styles.buttonText}>Approve</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.denyButton}
              onPress={() => handleDeny(company.id)}
            >
